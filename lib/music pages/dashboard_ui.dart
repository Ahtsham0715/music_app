                        ...
                        children: [
                          ...
                          GridView.builder(
                            ...
                            itemBuilder: (context, index1) {
                              print(allmusic[cats[index]['id']][index1]
                                  ['song_name']);
                                ...
                                onTap: () {
                                  ...
                                  Get.to(() => const MusicPlayerUi(),
                                      arguments: {
                                        ...
                                        'song_id': allmusic[cats[index]['id']]
                                            [index1]['id'],
                                        'song_name': allmusic[cats[index]['id']]
                                            [index1]['song_name'],
                                        'desc': allmusic[cats[index]['id']]
                                            [index1]['desc'],
                                        'artist': allmusic[cats[index]['id']]
                                            [index1]['artist'],
                                        'song_type': allmusic[cats[index]['id']]
                                            [index1]['song_type'],
                                        'language': allmusic[cats[index]['id']]
                                            [index1]['language'],
                                        'song_mp3': allmusic[cats[index]['id']]
                                            [index1]['song_mp3'],
                                        'music_img': allmusic[cats[index]['id']]
                                            [index1]['music_img'],
                                      });
                                },
                                child: Column(
